...
namespace lzham
{
   ...
   // Some toolchains (clang's libc++) pull <stdint.h> in before this header
   // and define INT8_MAX/UINT32_MAX/... as macros, which collide with the
   // const names below. Undefine them so LZHAM's own constants are used.
#undef INT8_MIN
#undef INT16_MIN
#undef INT32_MIN
#undef INT64_MIN
