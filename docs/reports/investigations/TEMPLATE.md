...
One of Investigating / Resolved / Closed - not a bug - on the line above; it
is what the index shows. State what evidence would move the investigation to
the next status.
...
Keep it scannable: one short paragraph per fact (what was observed, how it
was discovered, when), then bullet lists for enumerations such as affected
surfaces or impact - not one dense paragraph carrying everything.
